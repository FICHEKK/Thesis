...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.2]{Packet-write}
	\caption{Example of writing data to a packet}
\end{figure}

Third benefit is cleaner code. Spotting an instance of \classname{Packet} immediately gives information to the reader that this code works with networking. Same could not be said for byte-array as its usages are much broader. \\
