...
\graphicspath{ {./images/Transport/} {./images/HLAPI/} {./images/Application/} }
...
This section lists and given brief explanation of all the scripts that have been developed to achieve multiplayer functionality in the game scene.
